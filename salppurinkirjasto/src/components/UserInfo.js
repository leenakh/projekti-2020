      ...
      <div className="user-info-container">
        ...
        <ul id="books">
          {reservationsToShow.map(r =>
            <li className="reservation-list-item" key={r.id}>
              <Info information={showInfo([r.book, r.numberOfCopies, r.received, r.beginDate, r.endDate, r.course])} />
              <div className="button-container">
                <table>
                  <tbody>
                    <tr><td className="user-info-cell">{r.received === false ? <ReceiveReservation id={r.id} setBeginDate={setBeginDate} setEndDate={setEndDate} /> : null}</td></tr>
                    <tr><td className="user-info-cell">{r.received === false ? <DisableReservation id={r.id} reservations={reservations} setReservations={setReservations} reservationsToShow={reservationsToShow} setReservationsToShow={setReservationsToShow} /> : null}</td></tr>
                    <tr><td className="user-info-cell"><RemoveReservation id={r.id} reservations={reservations} setReservations={setReservations} reservationsToShow={reservationsToShow} setReservationsToShow={setReservationsToShow} /></td></tr>
                  </tbody>
                </table>
              </div>
            </li>)}
